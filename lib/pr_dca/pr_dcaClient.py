...
class pr_dca(object):
    ...
    def _check_job(self, job_id):
        return self._client._check_job('pr_dca', job_id)

    def _run_dbcan_submit(self, DBCanParams, context=None):
        return self._client._submit_job(
             'pr_dca.run_dbcan', [DBCanParams],
             self._service_ver, context)

    def run_dbcan(self, DBCanParams, context=None):
        """
        ...
        """
        job_id = self._run_dbcan_submit(DBCanParams, context)
    ...
    def status(self, context=None):
        return self._client.call_method('pr_dca.status',
                                        [], self._service_ver, context)
