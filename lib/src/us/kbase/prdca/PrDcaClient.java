...
/**
 * <p>Original spec-file module name: pr_dca</p>
 * <pre>
 * A KBase module: pr_dca
 * </pre>
 */
public class PrDcaClient {
     ...
     * validity.
     */
    public PrDcaClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public PrDcaClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public PrDcaClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    protected <T> JobState<T> _checkJob(String jobId, TypeReference<List<JobState<T>>> retType) throws IOException, JsonClientException {
        ...
        args.add(jobId);
        List<JobState<T>> res = caller.jsonrpcCall("pr_dca._check_job", args, retType, true, true);
        return res.get(0);
    }

    /**
     * <p>Original spec-file function name: run_dbcan</p>
     * <pre>
     * </pre>
     * @param   arg1   instance of type {@link us.kbase.prdca.DBCanParams DBCanParams}
     * @return   instance of type {@link us.kbase.prdca.ResultsToReport ResultsToReport}
     * @throws IOException if an IO exception occurs
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    protected String _runDbcanSubmit(DBCanParams arg1, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        List<Object> args = new ArrayList<Object>();
        args.add(arg1);
        TypeReference<List<String>> retType = new TypeReference<List<String>>() {};
        List<String> res = caller.jsonrpcCall("pr_dca._run_dbcan_submit", args, retType, true, true, jsonRpcContext);
        return res.get(0);
    }
     ...
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    public ResultsToReport runDbcan(DBCanParams arg1, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        String jobId = _runDbcanSubmit(arg1, jsonRpcContext);
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("pr_dca.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
